<template>
        ...
        <div class="row"   style="margin-bottom: 1%">
            <img style="border-style: solid;border-color: #00A6EB; margin-left:2%" :src="'/storage/images/'+authe.photo" width="40px" height="40px" class="rounded-circle"/>
            ...
            <li class="row">
                ...
                <div class="card" >
                    ...
                    <div class="row">
                        ...
                        &nbsp;&nbsp;&nbsp;<small><a  v-if="comm.comment_user_id === authe.id || utili_id=== authe.id" data-toggle="modal" :data-target="'#myModal'+ comm.id" href=""><i  class="fa fa-times-circle"></i></a></small>

                        <!------------------------Modal supprimer------------------------------------------------->
                        <div class="modal fade" :id="'myModal'+ comm.id" >
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button class="btn btn-danger"  @click="supprimerCommentaire(comm.id)" data-dismiss="modal"> Confirmer</button>
                                    </div>
...
return{
    ...
    commentaires:[],
    authe:this.authh,
    utili_id:this.id_user,
    commentVoir:this.commentb,
    url:'http://util.web/indexCommentaire/'+this.id+'/',
...
props:['id','authh','commentb','id_user'],
...
methods: {
    ...
    ajouterCommentaire()  {
        let $this = this
        axios.post('http://util.web/ajouterCommentaire/'+this.id, {
    ...
    supprimerCommentaire(id){
        axios.get('http://util.web/supprimerCommentaire/'+id
        ).then(response => {
