        ...
        <div class="row">
            <div class="col-md-4 " >
                ...
                <div class="list-group">
                    <a href="/groupeAcademique/{{$groupeAca->id}}" style="color: black;" ><div class="list-group-item">
                            <h5> <i class="fa fa-home"> </i>&nbsp;&nbsp;&nbsp;&nbsp;Groupe</h5>
                        </div></a>

                    <a href="/groupeAcademiquePhoto/{{$groupeAca->id}}" style="color: black;" ><div class="list-group-item">
                        <h5><i class="fa fa-image"> </i>&nbsp;&nbsp;&nbsp;&nbsp;Photo</h5>
                        </div></a>
                    <a href="/groupeAcademiqueFichier/{{$groupeAca->id}}" style="color: black;" >
                    <div class="list-group-item">
                        <h5><i class="fa fa-file"> </i>&nbsp;&nbsp;&nbsp;&nbsp;Fichier</h5>
                    </div>
                    </a>
                    <a href="/groupeAcademiqueMembre/{{$groupeAca->id}}" style="color: black;" >
                    <div class="list-group-item">
