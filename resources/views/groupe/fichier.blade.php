...
@section('contenu')
    @if(count($files)>0  )
        ...
        <div class="card">
            <div class="card-header" style="font-weight: bold"> La list des fichies</div>
                    ...
                    @foreach($files as $file)
                        ...
                        <div class="row" style="border-bottom:1px solid #ccc; margin-bottom:15px">
                            ...
                            <div class="col-md-3 pull-right">
                                <a  href="/download/{{$file->id}}" style="margin-left: 35%;margin-top: 2%"><i class="fa fa-download" style="color: #303030">Télécharger</i></a>
                            </div>
